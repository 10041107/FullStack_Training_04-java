...
public class Applicartion01 {
    ...
    public static void main(String[] args){
        ...
        * 객체지향 프로그래밍의 꽃이라고 불리울 정로도 활용성이 높고 장점이 많다.
        ...
        *    하지만 이 부분은 이견이 많이 존재하기 때문에 다형성을 이해하는데 참고로만 사용하다.
...
//        ((Rabbit) animal2).jump();
        ...
        System.out.println("animal1 이 Rabbit와 같은지 확인 : " + (animal1 instanceof Rabbit));
