...
public class Application01 {
    ...
    public static void main(String[] args){
        ...
        *   1-2. 공통적으로 사용하는 코드가 무모 클래스에서 존재하면 수정사항이 생길 시 부모 클래스만 수정해도
        *        전체적으로 적용된다.(유지보수성 증가)
        ...
        * 그래야 자식클래스로 생성한 객체들이 서로 역할을 수행해가며 유연한 코드를 작성할 수 잇게 된다.
